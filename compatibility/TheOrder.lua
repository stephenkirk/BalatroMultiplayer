...
function create_card(_type, area, legendary, _rarity, skip_materialize, soulable, forced_key, key_append)
	if MP.LOBBY.config and MP.LOBBY.config.the_order then
...
function CardArea:shuffle(_seed)
	if MP.INTEGRATIONS.TheOrder and not (MP.LOBBY.config and MP.LOBBY.config.disable_the_order) and self == G.deck then
		local centers =
